...
class TCIntf( Intf ):
    ...
    def bwCmds( self, bw=None, speedup=0, use_hfsc=False, use_tbf=False, use_htb=False,
                latency_ms=None, enable_ecn=False, enable_red=False,red_limit = 1000000, 
                red_min=30000, red_max=35000,red_avpkt=1000, red_burst=20, red_prob=1.0):
        ...
        if bw and ( bw < 0 or bw > self.bwParamMax ):
            ...
            # ECN or RED 
                ...
                parent = ' parent 5:1 '
            # else:
            #     cmds +=[ '%s qdisc add dev %s root handle 5: pfifo limit 1000']
            #     parent = ' parent 5:1 '
    ...
    def config(self, bw=None, delay=None, jitter=None,loss=None, gro=False,txo=True,rxo=True,
                speedup=0, use_hfsc=False, use_tbf=False, use_htb=False, latency_ms=None,enable_ecn=False,
                enable_red=False, max_queue_size=None, red_limit=1000000,
                red_min=30000, red_max=35000, red_avpkt=1000, red_burst=20,
                red_prob=1.0, **params ):
        ...
        bwcmds, parent = self.bwCmds( bw=bw, speedup=speedup,
                                      use_hfsc=use_hfsc, use_tbf=use_tbf,use_htb=use_htb,
