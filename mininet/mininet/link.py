...
class TCIntf( Intf ):
    ...
    def config( self, bw=None, delay=None, loss=None, disable_gro=True,
        ...
        # ECN / RED goes moved from last to here in compliance with current mininet version
        markingcmds, parent = self.markingCmds(parent=parent, bw=bw, enable_ecn=enable_ecn,
