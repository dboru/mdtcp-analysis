        ...
        do 
          ...
          do
            ...
            then 
              ...
              then
                DURATION=60
                subdir='mdtcp-fct-web-'$cdate'-bw'$bw'delay'$delay'ft'$pod'load'$load'num_reqs'$num_reqs
              elif [ $mytest -eq 0 ]; 
                then
                  DURATION=10
                ...
                then
                  ...
                  then
                    DURATION=60
                    subdir='mptcp-fct-web-'$cdate'-bw'$bw'delay'$delay'ft'$pod'load'$load'num_reqs'$num_reqs
                  elif [ $mytest -eq 0 ]; 
                    then
                      DURATION=10
                  ...
                  # --enable_red $enable_red --g 4 --subflows $subflows --avg_alfa 0 --mdtcp_debug $mdtcp_debug --num_reqs $num_reqs\
                  # --test $mytest --qmon $qmon --iter $m   --load $load  --avg_flow_length 500 --bwm  $bwm  
                  ...
                  then
                    for f in $subflows
                    do
                      python plot_queue_monitor.py -f results/$subdir/$WORKLOAD/flows$f'g4'/queue_size* -o plots/$subdir-$WORKLOAD-flows$f
                    done
                  fi
              	  ...
              	  for f in $subflows
              	  do
                    python process_bwm_ng_rates.py -f results/$subdir/$WORKLOAD/flows$f'g4'/rates_iter* -o plots/$subdir-$WORKLOAD-flows$f
              	  done 
              	  fi
